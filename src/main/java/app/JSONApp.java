...
public class JSONApp {
    ...
    public static JsonObject sessionResult() {
        ...
        jsonObject2.add(new JsonPair("course", new JsonString("OOP")));
        jsonObject2.add(new JsonPair("mark", new JsonNumber(3)));
        jsonObject2.add(new JsonPair("passed", new JsonBoolean(true)));

        JsonObject jsonObject3 = new JsonObject();
        jsonObject3.add(new JsonPair("course", new JsonString("English")));
        jsonObject3.add(new JsonPair("mark", new JsonNumber(5)));
        jsonObject3.add(new JsonPair("passed", new JsonBoolean(true)));

        JsonObject jsonObject4 = new JsonObject();
        jsonObject4.add(new JsonPair("course", new JsonString("Math")));
        jsonObject4.add(new JsonPair("mark", new JsonNumber(2)));
        jsonObject4.add(new JsonPair("passed", new JsonBoolean(false)));

        JsonArray jsonArray = new JsonArray(jsonObject2, jsonObject3, jsonObject4);
